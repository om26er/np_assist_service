...
from np_assist_service.helpers import ConfigHelpers

# Build paths inside the project like this: os.path.join(BASE_DIR, ...)
BASE_DIR = os.path.dirname(os.path.dirname(os.path.abspath(__file__)))

CONFIG_FILE = os.path.expanduser('~/np_assist_config.ini')
...
SECRET_KEY = '@$c_rsxja-x$f2_+$ve7e39z+)a*f4^e^x48x=*j!vv%9fm8l@'
...
ROOT_URLCONF = 'np_assist_service.urls'
AUTH_USER_MODEL = 'main.User'
APP_NAME = 'National Property Assist'
...
WSGI_APPLICATION = 'np_assist_service.wsgi.application'
